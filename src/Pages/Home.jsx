	...
	return (
		<>
			...
			<div className="big">
				<div className="first">
					<p>
						Hey Folks! This is an initiative by the students of the college to build a
						coding club that will serve the purpose of providing the environment for
						coders to flourish and shine. We will create a platform which allows
						students to gain assistance and mentorship to enhance their coding ability.
						Our aim is to propagate the enthusiasm for coding in the institute and
						especially amongst freshmen. Moreover, the best skilled coders will be there
						to guide you through the process. This endeavour is not just for creating a
						culture for competitive coding but we also will mentor you in technologies
						like Machine Learning , Web Development , Android App Development and many
						more. So come forward and be a part of CodeShows family.
					</p>
					<div className="icons">
			...
			<div className="footer">
				...
				<div className="footer-text">
					Address: et magnis dis parturient montes nascetur ridiculus mus mauris vitae
